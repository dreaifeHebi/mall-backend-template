...
public class AlipayController {
    ...
    @ApiOperation(value = "H5支付系统集成测试",notes = "测试H5支付系统与原有支付宝系统的集成")
    @RequestMapping(value = "/h5-integration-test", method = RequestMethod.GET)
    @ResponseBody
    public CommonResult<Map<String, Object>> h5IntegrationTest(){
        Map<String, Object> result = new HashMap<>();
        result.put("message", "H5支付系统已成功集成");
        result.put("supportedChannels", Arrays.asList("ALIPAY_H5", "WECHAT_H5", "CREDIT_CARD"));
        result.put("h5PaymentEndpoint", "/payment/h5/create");
        result.put("testPage", "/h5-payment-test.html");
        result.put("timestamp", new Date());
        return CommonResult.success(result, "H5支付系统集成测试成功");
    }
}
