...
public interface PortalOrderDao {
    ...
    /**
     * 根据商品的skuId同时扣减SKU库存和商品库存
     */
    int reduceSkuAndProductStock(@Param("productSkuId")Long productSkuId,@Param("quantity") Integer quantity);

    /**
     * 根据商品ID扣减商品库存，用于没有SKU的轻量模板购物车商品
     */
    int reduceProductStock(@Param("productId") Long productId,@Param("quantity") Integer quantity);
