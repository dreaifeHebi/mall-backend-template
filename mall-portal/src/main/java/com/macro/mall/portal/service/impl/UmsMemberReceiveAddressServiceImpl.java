...
public class UmsMemberReceiveAddressServiceImpl implements UmsMemberReceiveAddressService {
     ...
     * 自动生成地址前缀
     */
    private void generatePrefixAddress(UmsMemberReceiveAddress address) {
        StringBuilder prefixBuilder = new StringBuilder();
        
        // 如果允许只输入州市的情况，且省份为空，则跳过省份
        if (address.getProvince() != null && !address.getProvince().trim().isEmpty()) {
            prefixBuilder.append(address.getProvince().trim());
        }
        ...
        if (address.getCity() != null && !address.getCity().trim().isEmpty()) {
            ...
            prefixBuilder.append(address.getCity().trim());
        }
        ...
        if (address.getRegion() != null && !address.getRegion().trim().isEmpty()) {
            ...
            prefixBuilder.append(address.getRegion().trim());
        }
        
        address.setPrefixAddress(prefixBuilder.toString());
    }
